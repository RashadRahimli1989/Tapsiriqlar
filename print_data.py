...
# print("Salam Menim adim Ayseldir.")
# print("Salam. \nMenim adim Ayseldir.")
# # "\n" yeni setirden yazir. "\t" 4 bosluq qoyur.
# print("Salam. \n\tMenim adim Ayseldir.")
# print("Yanvar", "Fevral", "Mart")
# print("Yanvar", "Fevral", "Mart", sep=", ")
# sep funksiyasi elementler arasinda ayiricidir.
print("Yanvar", "Fevral", "Mart", sep=", ", end="!!!\n")
print("Salam Adim Ayseldir")
# end parametri sonda hansi simvolun olacagini teyin edir. End parametri olan setr novbeti printle yanasi dusur.
